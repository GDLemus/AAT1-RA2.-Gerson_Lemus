...
public class Modificar_Clientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Modificar Clientes");
...
public void Mostrar(int id){
     c_codigo.setText(Clientes.clientes.get(id).getCcodigo()+"");
     c_nombre.setText(Clientes.clientes.get(id).getCnombre()+"");
     c_nit.setText(Clientes.clientes.get(id).getCnit()+"");
     c_correo.setText(Clientes.clientes.get(id).getCcorreo()+"");
     c_pass.setText(Clientes.clientes.get(id).getCpass()+"");
}
